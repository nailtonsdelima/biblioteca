...
?>
	...
	<label>Nome: </label>
	<input type="text" name="name" value="<?php echo $us['user_name']; ?>" placeholder="Digite seu nome" class="form-control" required>
	<br>

	<label>Email: </label>
	<input type="email" name="email" value="<?php echo $us['user_email']; ?>" placeholder="Digite seu email" class="form-control" required>
	<br>
